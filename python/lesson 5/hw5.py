...
# file = open(r"python\lesson 5\example.txt", "r", encoding="utf-8")
# content = file.read()
# print(content)
# file.close()

# # --------- 2. Создайте файл output.txt и запишите в него строку "Hello, World!"
# with open(r"python\lesson 5\output.txt", "w", encoding="utf-8") as file:
...
myfile = "python\lesson 5\example1.txt"
